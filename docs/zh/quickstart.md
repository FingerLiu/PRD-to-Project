...
> 10分钟内将您的 PRD 转化为功能完整的项目。

本指南将帮助您使用 AI 将产品需求文档（PRD）转换为可工作的应用程序。无论您是构建 Web 应用、移动应用还是微信小程序，都可以学习如何利用我们的 AI 驱动开发平台高效地交付项目。
...
- [选择 PRD 模板](#选择-prd-模板)
- [开始使用](#开始使用)
  - [在 Windsurf 中打开项目](#1-在-windsurf-中打开项目)
  - [开始开发](#2-开始开发)
  - [调试和测试](#3-调试和测试)
  - [部署上线](#4-部署上线)
- [迭代和更新](#5-迭代和更新)
